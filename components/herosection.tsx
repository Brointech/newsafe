    ...
    <section className=" relative overflow-hidden min-h-screen">
      ...
      <div className="relative flex flex-col lg:flex-row items-center gap-0 min-h-screen">
        ...
        <div className="lg:ml-32 mt-26 flex flex-col gap-8">
          <h1 className="text-black text-[32px] mt-4 sm:text-[34px] md:text-[44px] lg:text-[50px] text-center lg:text-left font-extrabold leading-[1.6]">
            Simple, Quick and <br className="hidden md:block" />
            Safe Banking
          </h1>
          <p className="text-gray-500 text-[18px] text-center lg:text-left sm:text-[18px] md:text-[22px] font-medium tracking-wide">
          ...
          <div className="flex justify-center sm:justify-center lg:justify-start">
            <button className="bg-[#034EA2] w-30 h-14 ml-0 md:ml-40 sm:mr-40 rounded-[7px] text-white font-semibold text-[12px] lg:text-[16px] transform hover:scale-105 transition-all duration-100 hover:bg-[#034EA2] cursor-pointer">
              Get Started
            </button>
          </div>
