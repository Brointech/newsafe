    ...
    <section className="py-16 px-4 md:px-10 lg:px-30">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left">
          <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-end font-bold text-gray-800 leading-tight">
            We make Savings <br className="hidden sm:block" />
            Convenient and Flexible
          </h2>

          {/* Paragraph */}
          <p className="mt-6 text-gray-500 text-base lg:text-end sm:text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
