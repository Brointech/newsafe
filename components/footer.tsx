...
export const Footer = () => {
  return (
    <footer className="bg-white text-gray-500 lg:px-32 px-6 sm:px-4 py-16">
      <div className="max-w-6xl mx-auto">
        {/* Top Section */}
        <div className="flex flex-col lg:flex-row lg:justify-between gap-12 ">
          {/* Left: Brand */}
          <div className="flex flex-col items-center px-4 lg:items-start text-center lg:text-left gap-4 max-w-sm">
            <img
              src="/safelogo.png"
              alt=""
