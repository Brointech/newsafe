...
//             </h1>
//             <p className="text-gray-500 text-base sm:text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
//               Corporate banking just got better. First of its kind in
//               microfinance banking. Easy documentation, no need for physical
//               contact.
//             </p>
//             <div className="flex justify-center lg:justify-start">
//               <button className="bg-[#034EA2] w-32 h-14 rounded-[7px] text-white font-semibold text-[12px] lg:text-[16px] transform hover:scale-105 transition-all duration-100 cursor-pointer">
...
//                         <FaCircleCheck className="text-blue-600 shrink-0" />
//                         <p className="text-[14px] text-slate-600">
//                           Form CO2 (company shareholding signature)
//                         </p>
//                       </div>
//                       <div className="flex items-center gap-4">
//                         <FaCircleCheck className="text-blue-600 shrink-0" />
//                         <p className="text-[14px] text-slate-600">
//                           Form CO7 (Original application for company business
//                           name)
//                         </p>
//                       </div>
//                       <div className="flex items-center gap-4">
...
//                         <FaCircleCheck className="text-blue-600 shrink-0" />
//                         <p className="text-[14px] text-slate-600">
//                           MEMAT (Memorandum and Article of Association)
//                         </p>
//                       </div>
//                       <div className="flex items-center gap-4">
//                         <FaCircleCheck className="text-blue-600 shrink-0" />
...
//                 </h2>
//                 <p className="mt-6 text-xl text-slate-500 max-w-4xl leading-relaxed">
//                   Safe Haven provides a more easy and flexible business savings,
//                   transfers and payment options. Transaction tracking made easy.
//                 </p>
//                 <div className="grid md:grid-cols-2 gap-16 mt-16">
//                   <div>
//                     <h3 className="text-blue-700 font-bold text-[14px] mb-8">
...
//                         <FaCircleCheck className="text-blue-600 shrink-0" />
//                         <p className="text-[14px] text-slate-600">
//                           Mandatory initial deposit: N10,000
//                         </p>
//                       </div>
//                     </div>
//                   </div>
