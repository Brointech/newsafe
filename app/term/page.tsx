  ...
  <div className="flex flex-col gap-4">
    ...
    <div className="space-y-2">
      ...
      <p className="text-[15px] leading-6 text-gray-600">
        These terms guide the general relationship between the Bank ("we", "us",
        "our") and the Customer ("you", "your", "yours") and are binding
        immediately you open an account with us.
      </p>
      <p className="text-[15px] leading-6 text-gray-600">
        Some other products and services may be offered by Safe Haven MFB as a
        part of the VB Service and each of them has its Terms and/or conditions
        and you are bound by these specific Terms and conditions as well.
      </p>
      <p className="text-[15px] leading-6 text-gray-600">
        You are encouraged to read these Terms carefully and to pay attention to
        the clauses contained here.
      </p>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          ...
          except you provide all required documents and complete the KYC
          procedure as may be set out by the Central Bank of Nigeria ('CBN') and
          other relevant regulators from time to time.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">1.2</span>
          We reserve the right to refuse to open or to close an account if we
          discover that information supplied for the creation of the account is
          false, incorrect or misleading.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">1.3</span>
          You agree to immediately inform us of any change to the information
          you have supplied to enable us update our records correctly.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">1.4</span>
          You must comply with the minimum balance requirement if any exists and
          any other conditions applicable to your accounts including Savings and
          Current account. Non-compliance shall be grounds for us to suspend or
          close your accounts.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          ...
          Each time you access your account or send instructions we shall have
          to confirm that we are dealing with you.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">2.2</span>
          If you are in our branch, we may request to see a valid means of ID
          (e.g national ID card, Voter's card) and that your signature matches
          that on our systems.
        </p>
        <p>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          ...
          It may happen that you are unable to use your account yourself. In
          such cases, you can appoint a proxy to act for you.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">3.2</span>
          You are permitted to issue a Power of Attorney, or a Proxy Mandate or
          any valid legal instrument required in the specific instance. Once we
          have your instruction and the valid document, the appointed proxy
          would be allowed to operate your account on your behalf.
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          a. You revoke the authority of the proxy and communicate this fact to
          us.
          <br />
          b. We believe it is in your best interest to restrict the proxy.
          <br />
    ...
    <div className="space-y-6">
      <h3 className="text-black text-[18px] font-semibold">
        4. YOUR ACCOUNT - ACCOUNT CATEGORIES, INTEREST, ACCOUNT-SPECIFIC TERMS
      </h3>
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          <span className="font-semibold text-black mr-3">4.1</span>
          We offer two categories of accounts for personal banking: Savings
        ...
        <p>
          ...
          Conditions, features and interest rates shall also be as contained on
          our website and as updated from time to time.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          ...
          We may at any time suspend your access to any or all parts of your
          accounts or any or all services available to you for any reason
          including but not limited to the following: Suspicion of fraud or
          crime, Compliance with the law, Suspicion that the security of your
          account has been compromised, or we are of the opinion that you may be
          unable to meet your obligations to repay a loan you owe to us.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">5.2</span>
          In any case, we shall inform you prior to or immediately after
          restricting your account and provide you with the reason we took the
          decision.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">5.3</span>
          Where your account has not been used for a period of time we may
          restrict your account but only to protect your account and always with
          notice. Restriction for non-usage would happen if your account is
          inactive: 12-months if a current account, 2 years if a savings
          account.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <h3 className="text-black text-[18px] font-semibold">
        6. ACCOUNT INFORMATION - UPDATES, STATEMENTS AND TRANSACTION INFORMATION
      </h3>
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          <span className="font-semibold text-black mr-3">6.1</span>
          You have the right to know what is happening with your account and we
          would always keep you updated. You shall always receive updates on
          transactions by text message and by email by default. Should you
          choose to opt out of text message updates, then you must sign the SMS
          Deactivation Indemnity Form.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">6.2</span>
          We shall also send you a monthly Statement of Account at the end of
          every month via email. You shall let us know if you notice a
          discrepancy in the statement and the actual transactions that occurred
          in the month, or if there is any unusual or incorrect payments on your
          account.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">6.3</span>
          You can also generate a Statement of Account for yourself through our
          online and mobile applications. If you ask for your statement on
          paper, we shall make provisions for you, however, this might come with
          a service charge.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          ...
          We may request information relating to your transactions and your
          account with us to help us meet our requirements under the Anti-Money
          Laundering/Combating the Financing of Terrorism Regulations.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">7.2</span>
          If we suspect fraudulent or criminal activity, and you refuse to
          provide information, we may try to get it from another source but
          within the limits of the law. We may also suspend your account if we
          believe you are withholding information.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">7.3</span>
          We will keep your information with us in line with our privacy policy
    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        ...
        <p>
          ...
          All monies paid into your account shall become useable for you and
          shall begin to accrue interest: Immediately, if the payment is made by
          cash at a branch as soon as we receive it, if the payment is made via
          other means.
        </p>
      </div>
    </div>
...
const corporateContent = (
  <div className="flex flex-col gap-4">
    ...
    <div className="space-y-2">
      ...
      <p className="text-[15px] leading-6 text-gray-600">
        Some other products and services may be offered by Safe Haven MFB as a
        part of the Virtual Banking Service and each of them has its Terms
        and/or conditions and you are bound by these specific Terms and
        conditions as well.
      </p>
      <p className="text-[15px] leading-6 text-gray-600">
        You are encouraged to read these Terms carefully and to pay attention to
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          <span className="font-semibold text-black mr-3">3.1</span>
          We offer two categories of accounts for corporate banking:
          <br />
          Savings Account
          <br />
          Current Account
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5 text-[15px] leading-6 text-gray-600 ml-12">
        <p>
          ...
          <br />
          a. Suspicion of fraud or crime
          <br />
          b. Compliance with the law
          <br />
          c. Suspicion that the security of your account has been compromised
          <br />
          d. We are of the opinion that you may be unable to meet your
          obligations to repay a loan you owe to us.
        </p>
        <p>
          <span className="font-semibold text-black mr-3">4.2</span>
          In any case, we shall inform you prior to or immediately after
        ...
        <p>
          ...
          inactive:
          <br />
          a. 12-months if a current account
          <br />
...
const virtualContent = (
  <div className="flex flex-col gap-4 pb-20">
    <p className="mt-10 text-[15px] lg:text-[20px] text-blue-800 font-bold">
      SAFE HAVEN MFB VIRTUAL BANKING GENERAL TERMS AND SERVICES
    </p>
    <div className="space-y-2">
      <h3 className="text-black text-[18px] font-semibold">INTRODUCTION</h3>
      <p className="text-[15px] leading-6 text-gray-600">
        These terms govern the use of Safe Haven MFB's virtual banking platforms
        including internet banking, mobile banking, and USSD services.
      </p>
    </div>
  </div>
);
...
const apiContent = (
  <div className="flex flex-col gap-4 pb-20">
    <p className="mt-10 text-[15px] lg:text-[20px] text-blue-800 font-bold">
      CUSTOMER API USAGE TERMS OF USE
    </p>
    <div className="space-y-2">
      <h3 className="text-black text-[18px] font-semibold">INTRODUCTION</h3>
      <p className="text-[15px] leading-6 text-gray-600">
        These terms govern access to and use of the Safe Haven MFB API by
...
//           <h3 className="text-black text-[18px] font-semibold">INTRODUCTION</h3>
//           <p className="text-[15px] leading-6 text-gray-600">
//             These terms guide the general relationship between the Bank ("we",
//             "us", "our") and the Customer ("you", "your", "yours") and are
//             binding immediately you open an account with us.
//           </p>
//           <p className="text-[15px] leading-6 text-gray-600">
//             Some other products and services may be offered by Safe Haven MFB as
//             a part of the VB Service and each of them has its Terms and/or
//             conditions and you are bound by these specific Terms and conditions
//             as well.
//           </p>
//           <p className="text-[15px] leading-6 text-gray-600">
...
//               account except you provide all required documents and complete the
//               KYC procedure as may be set out by the Central Bank of Nigeria
//               ('CBN') and other relevant regulators from time to time.
//             </p>
//             <p>
//               <span className="font-semibold text-black mr-3">1.2</span>
...
//               and any other conditions applicable to your accounts including
//               Savings and Current account. Non-compliance shall be grounds for
//               us to suspend or close your accounts.
//             </p>
//           </div>
//         </div>
...
//             <p>
//               <span className="font-semibold text-black mr-3">3.2</span>
//               You are permitted to issue a Power of Attorney, or a Proxy Mandate
//               or any valid legal instrument required in the specific instance.
//               Once we have your instruction and the valid document, the
//               appointed proxy would be allowed to operate your account on your
//               behalf.
//             </p>
//             <p>
//               <span className="font-semibold text-black mr-3">3.3</span>
...
//               compromised or you feel they may be compromised.
//               <br />
//               a. You revoke the authority of the proxy and communicate this fact
//               to us.
//               <br />
//               b. We believe it is in your best interest to restrict the proxy.
//               <br />
...
//             <p>
//               <span className="font-semibold text-black mr-3">4.3</span>
//               Conditions, features and interest rates shall also be as contained
//               on our website and as updated from time to time.
//             </p>
//           </div>
//         </div>
...
//               including but not limited to the following: Suspicion of fraud or
//               crime Compliance with the law Suspicion that the security of your
//               account has been compromised We are of the opinion that you may be
//               unable to meet your obligations to repay a loan you owe to us.
//             </p>
//             <p>
//               <span className="font-semibold text-black mr-3">5.2</span>
...
//               <span className="font-semibold text-black mr-3">5.3</span>
//               Where your account has not been used for a period of time we may
//               restrict your account but only to protect your account and always
//               with notice. Restriction for non-usage would happen if your
//               account is inactive: 12-months if a current account 2 years if a
//               savings account
//             </p>
//           </div>
//         </div>
...
//             <p>
//               <span className="font-semibold text-black mr-3">6.1</span>
//               You have the right to know what is happening with your account and
//               we would always keep you updated. You shall always receive updates
//               on transactions by text message and by email by default. Should
//               you choose to opt out of text message updates, then you must sign
//               the SMS Deactivation Indemnity Form.
//             </p>
//             <p>
//               <span className="font-semibold text-black mr-3">6.2</span>
...
//             <p>
//               <span className="font-semibold text-black mr-3">6.3</span>
//               You can also generate a Statement of Account for yourself through
//               our online and mobile applications. If you ask for your statement
//               on paper, we shall make provisions for you, however, this might
//               come with a service charge.
//             </p>
//           </div>
//         </div>
...
//               <span className="font-semibold text-black mr-3">7.1</span>
//               We may request information relating to your transactions and your
//               account with us to help us meet out requirements under the
...
//               If we suspect fraudulent or criminal activity, and you refuse to
//               provide information, we may try to get it from another source but
//               within the limits of the law. We may also suspend your account if
//               we believe you are withholding information.
//             </p>
//             <p>
//               <span className="font-semibold text-black mr-3">7.3</span>
...
//               <span className="font-semibold text-black mr-3">8.2</span>
//               All monies paid into your account shall become useable for you and
//               shall begin to accrue interest: Immediately, if the payment is
//               made by cash at a branch as soon as we receive it, if the payment
//               is made via other means.
//             </p>
//           </div>
//         </div>
//       </div>
...
//         <div
//             id="section-2"
//             className="lg:col-span-2 mt-30 flex flex-col gap-4"
//           >
//             <p className="mt-20 text-[15px] lg:text-[20px] text-blue-800 font-bold">
...
// const Term = () => {
//   const [activeId, setActiveId] = useState("introduction"); //default to first tab
...
//             Terms and Conditions
//           </h1>
//           {/* Renders whichever category is active */}
//             {activeCategory?.content}
//           </div>
...
//                           {i < categories.length 1 && <hr className="my-1 border-gray-100" />}
//                         </div>
//                       );
//                     })}
//                   </nav>
