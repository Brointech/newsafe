...
const sections = [
  ...
  { id: "section-1", label: "1. Your Account - Opening, Access, Usage" },
  { id: "section-2", label: "2. Your Account - Confirming It Is You" },
  { id: "section-3", label: "3. Your Account - Proxies" },
  {
    id: "section-4",
    label: "4. Account Categories, Interest, Account-Specific Terms",
  },
  { id: "section-5", label: "5. Your Account - Restricting Access" },
  { id: "section-6", label: "6. Account Information - Updates, Statements" },
  { id: "section-7", label: "7. Account Information - Privacy" },
  { id: "section-8", label: "8. Payments - Into Account" },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 mt-30 flex flex-col gap-4">
            ...
            {/* Introduction */}
            <div id="introduction" className="space-y-2 scroll-mt-28">
              ...
              <p className="text-[15px] leading-6 text-gray-600">
                ...
                MFB as a part of the VB Service and each of them has its Terms
            ...
            {/* Section 2 */}
            <div id="section-2" className="space-y-6 scroll-mt-28">
              <h3 className="text-black text-[18px] font-semibold">
            ...
            {/* Section 3 */}
            <div id="section-3" className="space-y-6 scroll-mt-28">
              <h3 className="text-black text-[18px] font-semibold">
            ...
            {/* Section 4 */}
            <div id="section-4" className="space-y-6 scroll-mt-28">
              <h3 className="text-black text-[18px] font-semibold">
            ...
            {/* Section 5 */}
            <div id="section-5" className="space-y-6 scroll-mt-28">
              <h3 className="text-black text-[18px] font-semibold">
            ...
            {/* Section 6 */}
            <div id="section-6" className="space-y-6 scroll-mt-28">
              <h3 className="text-black text-[18px] font-semibold">
            ...
            {/* Section 7 */}
            <div id="section-7" className="space-y-6 scroll-mt-28">
              <h3 className="text-black text-[18px] font-semibold">
            ...
            {/* Section 8 */}
            <div id="section-8" className="space-y-6 scroll-mt-28 pb-20">
              <h3 className="text-black text-[18px] font-semibold">
                      ...
                      return (
                        <div key={id}>
                          ...
                          >
                            ...
                            <span
                              className={`mt-1.5 w-2 h-2 rounded-full shrink-0 transition-all duration-150 ${
                                isActive
